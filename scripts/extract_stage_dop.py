...
def main() -> None:
    ...
    parser.add_argument(
        "--plan-info",
        default="/mnt/data_sdc/serverless_tools/data_kunpeng/tpch_output_22/plan_info.csv",
        help="Path to plan_info.csv (semicolon-separated).",
    )
    parser.add_argument(
        "--pipeline-optimization",
        default="/mnt/data_sdc/serverless_tools/output/tpch/optimization_results/pipeline_optimization.csv",
        help="Path to pipeline_optimization.csv (comma-separated).",
    )
    parser.add_argument(
        "--output",
        default="/mnt/data_sdc/serverless_tools/output/tpch/optimization_results/query_stage_dop.csv",
