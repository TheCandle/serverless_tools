...
from utils import (
    ...
    setup_file_logging, log_experiment_start, log_experiment_end, safe_import, Timer,
...
def main():
    ...
    # Setup file logging
    setup_file_logging(log_dir='logs', log_prefix=f"train_{args.method}_{args.dataset}_{args.train_mode}")
